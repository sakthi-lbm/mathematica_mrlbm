...
SetBoundary[name_] := Module[{},
  Which[
    ...
    name == "left_inter", (Is = {0,2,3,4,6,7}; Os = {0,1,2,4,5,8}; bcName = name),
    name == "right_inter", (Is = {0,1,2,4,5,8}; Os = {0,2,3,4,6,7}; bcName = name),
    name == "top_left_inter", (Is = {0,2,3,6}; Os = {0,1,4,8}; bcName = name),
    name == "top_right_inter", (Is = {0,1,2,5}; Os = {0,3,4,7}; bcName = name),
    name == "bottom_left_inter", (Is = {0,3,4,7}; Os = {0,1,2,5}; bcName = name),
    name == "bottom_right_inter", (Is = {0,1,4,8}; Os = {0,2,3,6}; bcName = name),
