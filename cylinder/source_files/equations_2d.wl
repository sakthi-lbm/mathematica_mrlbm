...
equxS = Simplify[(1 - omega)*Total[f[Os + 1]* cx[[Is + 1]]] + omega*Total[feq[Os + 1]* cx[[Is + 1]]]] - rhoI*uxI == 0;
equyS = Simplify[(1 - omega)*Total[f[Os + 1]* cy[[Is + 1]]] + omega*Total[feq[Os + 1]* cy[[Is + 1]]]] - rhoI*uyI == 0;
